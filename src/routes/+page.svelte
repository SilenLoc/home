<header class="dark">
    ...
    <div
            class="h-screen bg-neutral-50 py-20 px-6 text-center text-neutral-800 dark:bg-neutral-700 dark:text-neutral-200 ">
        <h1 class="mb-6 text-5xl font-bold">I am working on this website</h1>
        <h3 class="mb-8 text-3xl font-bold">promise</h3>
